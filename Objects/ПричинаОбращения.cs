...
namespace Sneg.Горводоканал
{
    ...
    [View("ПричинаОбращенияL", new string[] {
            ...
            "Код as \'Код\'",
            "Актуально as \'Актуально\'"})]
    public class ПричинаОбращения : Sneg.Горводоканал.Справочник
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПричинаОбращенияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинаОбращенияE", typeof(Sneg.Горводоканал.ПричинаОбращения));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПричинаОбращенияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинаОбращенияL", typeof(Sneg.Горводоканал.ПричинаОбращения));
                }
            }
        }
    }
