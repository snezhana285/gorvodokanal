...
namespace Sneg.Горводоканал
{
    ...
    [View("СотрудникL", new string[] {
            ...
            "EMail as \'E mail\'",
            "Актуально as \'Актуально\'"})]
    public class Сотрудник : Sneg.Горводоканал.Справочник
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(Sneg.Горводоканал.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(Sneg.Горводоканал.Сотрудник));
                }
            }
        }
    }
